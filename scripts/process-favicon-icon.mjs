/**
 * Favicon – usuwa białe tło (flood fill), zapis WebP.
 * node scripts/process-favicon-icon.mjs [źródło.png|jpg]
 */
import fs from "fs";
...
const OUT = path.join(ROOT, "public", "images", "favicon-icon.webp");
const DEFAULT_SRC = path.join(ROOT, "public", "images", "favicon-source.png");
